  ...
  describe("verifyCreateMarketPreDeposit", () => {
    ...
    it("should verify successfully if sent directly to Factory", async () => {
      ...
      (decodeFunctionData as jest.Mock).mockReturnValue({
        ...
        args: ["0x60d0fe4f5311236168a109ca0000000000000000000000000000000000000000", BigInt(5000000)],
      });

      const result = await service.verifyCreateMarketPreDeposit("0xTxHash", "60d0fe4f5311236168a109ca");
    ...
    it("should verify successfully if sent through Router", async () => {
      ...
      (decodeFunctionData as jest.Mock).mockReturnValue({
        functionName: "createMarketPreDeposit",
        args: ["0xfactory", "0x60d0fe4f5311236168a109ca0000000000000000000000000000000000000000", BigInt(5000000)],
      });
  ...
  describe("verifyDepositPreMarketLiquidity", () => {
    ...
    it("should verify successfully if sent directly to Factory", async () => {
      ...
      (decodeFunctionData as jest.Mock).mockReturnValue({
        ...
        args: ["0x60d0fe4f5311236168a109ca0000000000000000000000000000000000000000", BigInt(10000000)],
      });

      const result = await service.verifyDepositPreMarketLiquidity("0xTxHash", "60d0fe4f5311236168a109ca");
    ...
    it("should verify successfully if sent through Router", async () => {
      ...
      (decodeFunctionData as jest.Mock).mockReturnValue({
        functionName: "depositPreMarketLiquidity",
        args: ["0xfactory", "0x60d0fe4f5311236168a109ca0000000000000000000000000000000000000000", BigInt(10000000)],
      });

import { Controller, Get, Patch, Post, Param, Query, Body, HttpCode, HttpStatus, UseGuards, Request } from "@nestjs/common";
...
export class NotificationsController {
  ...
  @ApiQuery({ name: "userId", required: false, description: "User ID (optional/ignored)" })

...
export class LiquidityController {
  ...
  async fundPool(
    ...
    return this.liquidityService.initializePool(marketId, creatorId, dto.creatorWallet, dto.txHash);
  }
  ...
  async addLiquidity(
    ...
    return this.liquidityService.addLiquidity(marketId, userId, dto.amount, dto.txHash);
  }
  ...
  async removeLiquidity(
    ...
    const userId = req.user.id;
    return this.liquidityService.removeLiquidity(marketId, userId, dto.lpShares, dto.txHash);
  }

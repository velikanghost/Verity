...
export class LiquidityPool {
  @Prop({ type: MongooseSchema.Types.ObjectId, ref: "Market", required: true, unique: true, index: true })
...
export class LPPosition {
  @Prop({ type: MongooseSchema.Types.ObjectId, ref: "LiquidityPool", required: true, index: true })
...
export class LiquidityEvent {
  ...
  @Prop({
    type: String,
    enum: ["creator_deposit", "lp_deposit", "lp_withdraw", "fee_earned", "refund"],
    required: true,
  })
  type: "creator_deposit" | "lp_deposit" | "lp_withdraw" | "fee_earned" | "refund";

...
export class UpdateUserDto {
  ...
  @ApiPropertyOptional({ description: "Updated display name", example: "John Doe Senior" })
  @IsOptional()
  @IsString()
  @Length(0, 80)
  ...
  @ApiPropertyOptional({ description: "Updated user bio", example: "Prediction market enthusiast" })
  @IsOptional()
  @IsString()
  @Length(0, 280)
  bio?: string | null;

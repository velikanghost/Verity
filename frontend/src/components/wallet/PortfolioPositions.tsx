    ...
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="rounded-[12px] border border-[(--border)] bg-[(--surface)] p-5 shadow-sm">
          ...
          <p className="mt-1 font-mono text-2xl font-black text-[(--color-brand-secondary)]">
              ...
              return (
                ...
                >
                  <div className="flex-1 min-w-0">
                    <span
                      className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-mono font-bold ${yes ? 'bg-[(--color-brand-secondary)]/10 text-[(--color-brand-secondary)] border border-[(--color-brand-secondary)]/20' : 'bg-[(--color-brand-accent)]/10 text-[(--color-brand-accent)] border border-[(--color-brand-accent)]/20'}`}
                    >
                      {pos.side}
                    </span>

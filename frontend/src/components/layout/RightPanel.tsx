            ...
            return (
              ...
              >
                ...
                <div className="mt-1 flex items-center justify-between">
                  <span className="font-mono text-xs font-bold text-[(--color-brand-secondary)]">{yes.toFixed(0)}% YES</span>
            ...
            {predictors.length > 0 ? predictors.map((user) => (
              ...
              >
                ...
                <div className="flex flex-col items-end">
                  <span className="text-sm font-black text-[(--color-brand-secondary)]">Live</span>
